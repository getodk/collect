...
Sites like [StackOverflow](http://stackoverflow.com/) will sometimes provide exactly the code snippet needed to solve a problem. You are encouraged to use such snippets in ODK Collect as long as you attribute them by including a direct link to the source. In addition to complying with the content license, this provides useful context for anyone reading the code. ODK Collect is released under the [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0) license, please make sure that any code you include is licensed in a compatible way. If no license is specified for a piece of code or if it has an incompatible license such as GPL, using it puts the project at legal risk.