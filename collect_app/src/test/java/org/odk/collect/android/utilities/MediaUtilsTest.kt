...
class MediaUtilsTest {
    ...
    private val activity = CollectHelpers.createThemedActivity(WidgetTestActivity::class.java)
    ...
    fun `When file that we try to open does not exist a toast should be displayed`() {
        ...
        mediaUtils.openFile(activity, file, "image/*")
    ...
    fun `When open file, launch on intentLauncher should be called with proper parameters`() {
        ...
        assertThat(contextCaptor.firstValue, `is`(activity))
