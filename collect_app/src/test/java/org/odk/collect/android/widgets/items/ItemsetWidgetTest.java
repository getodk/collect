...
public class ItemsetWidgetTest extends QuestionWidgetTest<ItemsetWidget, StringData> {
    ...
    public ItemsetWidget createWidget() {
        return new ItemsetWidget(activity, new ItemsetQuestionDetails(formEntryPrompt, "formAnalyticsID", parseTool, adapter, fileUtil), false, false);  // smap add readonly override
    }
