...
public class DecimalWidgetTest extends QuestionWidgetTest<DecimalWidget, DecimalData> {
    ...
    public DecimalWidget createWidget() {
        return new DecimalWidget(activity, new QuestionDetails(formEntryPrompt), false);
    }
    ...
    public void integerValueShouldDisplayNoDecimalPoint() {
        ...
        DecimalWidget decimalWidget = new DecimalWidget(activity, new QuestionDetails(formEntryPrompt), false);

        assertThat(decimalWidget.getAnswerText(), is(equalTo(integerString)));

        decimalWidget = new DecimalWidget(activity, new QuestionDetails(formEntryPrompt), false);
