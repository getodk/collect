...
public class GeoTraceWidgetTest {
    ...
    public void whenPromptIsReadOnlyAndHasAnswer_viewGeoShapeButtonIsShown() {
        ...
        assertEquals(widget.binding.getPolylineButton.getText(), widget.getContext().getString(org.odk.collect.strings.R.string.geotrace_view_read_only));
    }

    @Test
    public void whenPromptIsNotReadOnlyAndDoesNotHaveAnswer_startGeoShapeButtonIsShown() {
        GeoTraceWidget widget = createWidget(promptWithAnswer(null));
        assertEquals(widget.binding.getPolylineButton.getText(), widget.getContext().getString(org.odk.collect.strings.R.string.get_trace));
    }

    @Test
    public void whenPromptIsNotReadOnlyAndHasAnswer_viewOrChangeGeoShapeButtonIsShown() {
        GeoTraceWidget widget = createWidget(promptWithAnswer(new StringData(answer)));
        assertEquals(widget.binding.getPolylineButton.getText(), widget.getContext().getString(org.odk.collect.strings.R.string.geotrace_view_change_location));
    }
