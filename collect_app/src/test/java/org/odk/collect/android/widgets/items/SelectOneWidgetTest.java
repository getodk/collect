...
public class SelectOneWidgetTest extends GeneralSelectOneWidgetTest<SelectOneWidget> {
    ...
    public SelectOneWidget createWidget() {
        SelectOneWidget selectOneWidget = new SelectOneWidget(activity, new QuestionDetails(formEntryPrompt, "formAnalyticsID"), isQuick(), false);     // smap add readonlyoverride
        if (isQuick()) {
