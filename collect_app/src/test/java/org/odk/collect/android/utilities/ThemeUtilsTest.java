...
public class ThemeUtilsTest {
    ...
    @Before
    public void setup() {
        DaggerUtils.getComponent((Collect) ApplicationProvider.getApplicationContext()).projectsRepository().save(new Project("https://my-server.com", "username", "1234", "Project 1", "P", "#ffffff", "1"));
