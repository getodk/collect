...
class FormsDownloadResultDialogTest {
    private val downloadErrorItem = org.odk.collect.errors.ErrorItem("", "", "")
    ...
    fun `The dialog should be dismissed after clicking out of it's area or on device back button`() {
        val args = Bundle()
        args.putSerializable(FormsDownloadResultDialog.ARG_FAILURES, arrayListOf<org.odk.collect.errors.ErrorItem>())
