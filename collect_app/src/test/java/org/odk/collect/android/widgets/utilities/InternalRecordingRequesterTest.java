...
public class InternalRecordingRequesterTest {
    ...
    public void setup() {
        ...
        requester = new InternalRecordingRequester(activity, waitingForDataRegistry, permissionUtils);
    ...
    public void requestRecording_startsRecordSoundIntentAndSetsWidgetWaitingForData() {
        ...
        assertThat(waitingForDataRegistry.isWaitingForData(prompt.getIndex()), is(true));
    }

    @Test
    public void requestRecording_whenPermissionDenied_doesNotStartIntentAndDoesNotWaitForData() {
        ...
        Intent startedActivity = shadowOf(activity).getNextStartedActivity();
        assertThat(startedActivity, is(nullValue()));

        assertThat(waitingForDataRegistry.isWaitingForData(prompt.getIndex()), is(false));
    }
}