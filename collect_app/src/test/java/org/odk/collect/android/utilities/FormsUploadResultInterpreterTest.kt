...
class FormsUploadResultInterpreterTest {
    ...
    fun `When not all forms uploaded successfully getFailures() should return list of failures`() {
        ...
        assertThat(FormsUploadResultInterpreter.getFailures(resultWithOneError, context)[0].secondaryText, `is`(context.getString(
            org.odk.collect.strings.R.string.form_details, "2", "2")))
