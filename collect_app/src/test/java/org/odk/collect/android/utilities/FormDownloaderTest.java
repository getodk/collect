...
public class FormDownloaderTest {
    ...
    @Mock
    CollectServerClient openRosaAPIClient;
    ...
    public void downloadingFormWithXmlExternalSecondaryInstance_Succeeds() throws Exception {
        ...
        when(openRosaAPIClient.getXmlDocument("https://testserver/manifest.xml")).thenReturn(buildManifestFetchResult("external-data.xml"));
        when(openRosaAPIClient.getHttpInputStream("https://testserver/external-data.xml",
                null)).thenReturn(new HttpGetResult(buildXmlExternalInstanceFetchResult(), new HashMap<>(), "foo", -1));
    ...
    public void downloadingFormWithCsvExternalSecondaryInstance_Succeeds() throws Exception {
        ...
        when(openRosaAPIClient.getXmlDocument("https://testserver/manifest.xml")).thenReturn(buildManifestFetchResult("external-data.csv"));
        when(openRosaAPIClient.getHttpInputStream("https://testserver/external-data.csv",
                null)).thenReturn(new HttpGetResult(buildCsvExternalInstanceFetchResult(), new HashMap<>(), "hash", -1));
    ...
    public void downloadingFormWithExternalSecondaryInstanceNamedLastSavedXml_Succeeds() throws Exception {
        ...
        when(openRosaAPIClient.getXmlDocument("https://testserver/manifest.xml")).thenReturn(buildManifestFetchResult("last-saved.xml"));
        when(openRosaAPIClient.getHttpInputStream("https://testserver/last-saved.xml",
                null)).thenReturn(new HttpGetResult(buildXmlExternalInstanceFetchResult(), new HashMap<>(), "hash", -1));
