...
public class ResetAppStateTest {
    ...
    public void resetFormsTest() throws IOException {
        ...
        assertFolderEmpty(StorageManager.FORMS_PATH);
    ...
    private void setupTestFormsDatabase() {
        ...
        values.put(FormsColumns.FORM_FILE_PATH, StorageManager.FORMS_PATH + "/testFile1.xml");
    ...
    private void saveTestFormFiles() throws IOException {
        assertTrue(new File(StorageManager.FORMS_PATH + "/testFile1.xml").createNewFile());
        assertTrue(new File(StorageManager.FORMS_PATH + "/testFile2.xml").createNewFile());
        assertTrue(new File(StorageManager.FORMS_PATH + "/testFile3.xml").createNewFile());

        assertTrue(new File(StorageManager.FORMS_PATH + "/testDir1/testFile1-media").mkdirs());
        assertTrue(new File(StorageManager.FORMS_PATH + "/testDir2/testFile2-media").mkdirs());
        assertTrue(new File(StorageManager.FORMS_PATH + "/testDir3/testFile3-media/testFile.csv").mkdirs());
    }
