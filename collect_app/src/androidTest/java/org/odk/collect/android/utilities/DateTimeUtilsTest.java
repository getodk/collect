...
public class DateTimeUtilsTest {
    ...
    public void getDateTimeLabelTest() {
        long dateInMilliseconds = 687956400000L; // 20 Oct 1991 11:00
        ...
        assertEquals("20 Okt 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 ኦክተ 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("٢٠ أكتوبر، ١٩٩١ ١١:٠٠", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("২০ অক্টোবর, ১৯৯১ ১১:০০", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 oct. 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20. 10. 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 de oct. de 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("1991 Oct 20 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("۲۰ اکتبر ۱۹۹۱،\u200F ۱۱:۰۰", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20. lokakuuta 1991 11.00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 अक्टू, 1991, 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("1991. okt. 20. 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20/ott/1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("1991 ഒക്ടോ 20 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("२० ऑक्टो, १९९१, ११:००", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("၁၉၉၁ အောက်တိုဘာ ၂၀ ၁၁:၀၀", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 paź 1991, 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("۲۰ اکتوبر ۱۹۹۱ ۱۱:۰۰", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 de out de 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 окт. 1991 г., 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20-Tob-1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 Tet 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 அக்., 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 Eki 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 жовт. 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("20 اکتوبر، 1991 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("11:00 20 thg 10, 1991", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
        ...
        assertEquals("1991年10月20日 11:00", DateTimeUtils.getDateTimeLabel(new Date(dateInMilliseconds), gregorianDatePickerDetails, true, context));
