...
public class Collect extends Application {
    ...
    public static void createODKDirs() throws RuntimeException {
        ...
        String[] dirs = {
                StorageManager.ODK_ROOT, StorageManager.FORMS_PATH, StorageManager.INSTANCES_PATH, StorageManager.CACHE_PATH, StorageManager.METADATA_PATH, StorageManager.OFFLINE_LAYERS
        };
    ...
    public static boolean isODKTablesInstanceDataDirectory(File directory) {
        ...
        if (dirPath.startsWith(StorageManager.ODK_ROOT)) {
            dirPath = dirPath.substring(StorageManager.ODK_ROOT.length());
