...
class TimedGridWidget(
    ...
    private val gridItems = items
        ...
        .map { GridItem(it.value, questionDetails.prompt.getSelectChoiceText(it)) }
    ...
    override fun onCreateWidgetView(
        ...
        val root = renderer.inflateView(inflater, this)
        renderer.bind(
            root,
            config,
            gridItems,
    ...
    override fun getWarningDialog(): Class<out DialogFragment> =
        OngoingAssessmentWarningDialogFragment::class.java
}
