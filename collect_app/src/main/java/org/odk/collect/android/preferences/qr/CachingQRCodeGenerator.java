...
public class CachingQRCodeGenerator implements QRCodeGenerator {
    ...
    public Observable<Bitmap> generateQRCode(Collection<String> selectedPasswordKeys) {
        return Observable.create(emitter -> {
            ...
            if (bitmap == null) {
                ...
                bitmap = generateQRBitMap(preferencesString);
    ...
    private Bitmap generateQRBitMap(String data) throws IOException, WriterException {
        final long time = System.currentTimeMillis();
        Bitmap bmp = QRCodeUtils.encode(data);
