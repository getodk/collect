...
public class XPathExprProvider extends ContentProvider {
    private static HashMap<String, String> xformExprsProjectionMap;
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        qb.setProjectionMap(xformExprsProjectionMap);
        qb.setStrict(true);
