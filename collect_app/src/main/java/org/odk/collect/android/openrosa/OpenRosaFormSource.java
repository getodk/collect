...
public class OpenRosaFormSource implements FormSource {
    ...
    public InputStream fetchForm(String formURL, boolean credentials) throws FormSourceException {   // smap add credentials
        return mapException(() -> openRosaXMLFetcher.getFile(formURL, null, credentials));           // smap add credentials
    }
    ...
    public InputStream fetchMediaFile(String mediaFileURL, boolean credentials) throws FormSourceException {   // smap add credentials
        return mapException(() -> openRosaXMLFetcher.getFile(mediaFileURL, null, credentials));   // smap add credentials
    }
