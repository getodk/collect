...
public class ManageForm {
    ...
    public void updateFormDetails(Long id, String displayName, boolean tasks_only, boolean read_only, boolean searchLocalData) {
        ...
        try {
			...
			values.put(FormsColumns.READ_ONLY, read_only ? "yes" : "no");
