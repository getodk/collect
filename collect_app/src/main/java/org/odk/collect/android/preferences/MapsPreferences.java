...
public class MapsPreferences extends BasePreferenceFragment {
    ...
    private void populateReferenceLayerPref() {
        ...
        File layerDir = FileUtils.simplifyPath(new File(new StoragePathProvider().getOfflineLayersDirPath()));
    ...
    private static List<File> getSupportedLayerFiles(MapConfigurator cftor) {
        ...
        for (File file : FileUtils.walk(new File(new StoragePathProvider().getOfflineLayersDirPath()))) {
