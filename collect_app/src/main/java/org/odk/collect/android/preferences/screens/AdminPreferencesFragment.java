    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        switch (preference.getKey()) {
            case PROJECT_NAME_KEY:
                projectsRepository.save(new Project(currentProject.getUsername(), currentProject.getUsername(), currentProject.getPassword(), String.valueOf(newValue), currentProject.getIcon(), currentProject.getColor(), currentProject.getUuid()));
                break;
            case PROJECT_ICON_KEY:
                projectsRepository.save(new Project(currentProject.getUsername(), currentProject.getUsername(), currentProject.getPassword(), currentProject.getName(), String.valueOf(newValue), currentProject.getColor(), currentProject.getUuid()));
                break;
            case PROJECT_COLOR_KEY:
                projectsRepository.save(new Project(currentProject.getUsername(), currentProject.getUsername(), currentProject.getPassword(), currentProject.getName(), currentProject.getIcon(), String.valueOf(newValue), currentProject.getUuid()));
                break;
        }
        return true;
    }
