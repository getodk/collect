 ...
 */
public class InstancesDatabaseHelperSmap extends SQLiteOpenHelper {
    private final DatabaseMigrator databaseMigrator;

    public InstancesDatabaseHelperSmap(DatabaseMigrator databaseMigrator, StoragePathProvider storagePathProvider) {
