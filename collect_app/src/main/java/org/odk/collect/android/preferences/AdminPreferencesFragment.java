...
import org.odk.collect.android.formentry.ChangeAdminPasswordDialog;
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        switch (preference.getKey()) {
            ...
            case KEY_CHANGE_ADMIN_PASSWORD:
                ChangeAdminPasswordDialog changeAdminPasswordDialog = new ChangeAdminPasswordDialog();
                changeAdminPasswordDialog.show(getFragmentManager(), "changeAdminPasswordDialog");
                break;
