...
public class AdminPreferencesFragment extends BasePreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        initCheckForFormUpdatesPeriodically();
    ...
    private void initCheckForFormUpdatesPeriodically() {
        final ListPreference pref = (ListPreference) findPreference(CHECK_FOR_FORM_UPDATES_PERIODICALLY);
