...
public abstract class AbstractSelectOneWidget extends SelectTextWidget
    ...
    public AbstractSelectOneWidget(Context context, FormEntryPrompt prompt, boolean autoAdvance, boolean readOnlyOverride) {
    ...
    protected RadioButton createRadioButton(int index, boolean readOnlyOverride) {
