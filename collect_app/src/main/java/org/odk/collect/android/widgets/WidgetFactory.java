    ...
    public QuestionWidget createWidgetFromPrompt(FormEntryPrompt prompt, PermissionsProvider permissionsProvider) {
        ...
        switch (prompt.getControlType()) {
                ...
                switch (prompt.getDataType()) {
                    ...
                    case Constants.DATATYPE_DECIMAL:
                        if (appearance.startsWith(Appearances.EX)) {
                            questionWidget = new ExDecimalWidget(context, questionDetails, waitingForDataRegistry, StringRequesterImpl.INSTANCE);
                    ...
                    case Constants.DATATYPE_INTEGER:
                        if (appearance.startsWith(Appearances.EX)) {
                            questionWidget = new ExIntegerWidget(context, questionDetails, waitingForDataRegistry, StringRequesterImpl.INSTANCE);
                        } else {
                    ...
                    case Constants.DATATYPE_TEXT:
                        ...
                        if (query != null) {
                            ...
                            questionWidget = new ExStringWidget(context, questionDetails, waitingForDataRegistry, StringRequesterImpl.INSTANCE);
            ...
            case Constants.CONTROL_FILE_CAPTURE:
                if (appearance.startsWith(Appearances.EX)) {
                    questionWidget = new ExArbitraryFileWidget(context, questionDetails, new MediaUtils(), questionMediaManager, waitingForDataRegistry, new ExternalAppIntentProvider(), FileRequesterImpl.INSTANCE);
                } else {
            ...
            case Constants.CONTROL_IMAGE_CHOOSE:
                if (appearance.equals(Appearances.SIGNATURE)) {
                    ...
                    questionWidget = new ExImageWidget(context, questionDetails, questionMediaManager, waitingForDataRegistry, new MediaUtils(), new ExternalAppIntentProvider(), FileRequesterImpl.INSTANCE);
                } else {
            ...
            case Constants.CONTROL_AUDIO_CAPTURE:
                ...
                if (appearance.startsWith(Appearances.EX)) {
                    questionWidget = new ExAudioWidget(context, questionDetails, questionMediaManager, audioPlayer, waitingForDataRegistry, new MediaUtils(), new ExternalAppIntentProvider(), FileRequesterImpl.INSTANCE);
                } else {
            ...
            case Constants.CONTROL_VIDEO_CAPTURE:
                if (appearance.startsWith(Appearances.EX)) {
                    questionWidget = new ExVideoWidget(context, questionDetails, questionMediaManager, waitingForDataRegistry, new MediaUtils(), new ExternalAppIntentProvider(), FileRequesterImpl.INSTANCE);
                } else {
