        ...
        switch (prompt.getControlType()) {
            ...
            case Constants.CONTROL_SELECT_ONE:
                ...
                if (!appearance.contains(WidgetAppearanceUtils.COMPACT_N) && (appearance.contains(WidgetAppearanceUtils.COMPACT)   // smap contains
                    ...
                    questionWidget = new SelectOneAutocompleteWidget(context, questionDetails, appearance.contains(WidgetAppearanceUtils.QUICK), readOnlyOverride);  // smap add readOnlyOverride
