...
class JavaRosaInitializer(private val propertyManager: PropertyManager) {
...
private class DynamicPreloadXFormParserFactory(private val wrapped: IXFormParserFactory) :
    XFormParserFactory() {
