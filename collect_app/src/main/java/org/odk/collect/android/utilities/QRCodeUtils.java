...
public class QRCodeUtils {
    public static final String QR_CODE_FILEPATH = new StoragePathProvider().getSettingsDirPath() + File.separator + "collect-settings.png";
    ...
    static final String MD5_CACHE_PATH = new StoragePathProvider().getSettingsDirPath() + File.separator + SETTINGS_MD5_FILE;
    ...
    public static Observable<Bitmap> getQRCodeGeneratorObservable(Collection<String> selectedPasswordKeys) {
        return Observable.create(emitter -> {
            ...
            File writeDir = new File(new StoragePathProvider().getSettingsDirPath());
            if (!writeDir.exists()) {
                if (!writeDir.mkdirs()) {
