        ...
        if (pref != null) {
            ...
            pref.setOnPreferenceChangeListener((preference, newValue) -> {
                ...
                if (key.equals(KEY_PERIODIC_FORM_UPDATES_CHECK)) {
                    ...
                    // Collect.getInstance().logRemoteAnalytics(AUTO_FORM_UPDATE_PREF_CHANGE, "Periodic form updates check", (String) newValue);  // smap comment out
    ...
    private void initPref(String key) {
        ...
        if (pref != null) {
            if (key.equals(KEY_AUTOMATIC_UPDATE)) {
                ...
                pref.setOnPreferenceChangeListener((preference, newValue) -> {
                    // Collect.getInstance().logRemoteAnalytics(AUTO_FORM_UPDATE_PREF_CHANGE, "Automatic form updates", newValue + " " + formUpdateCheckPeriod);  // smap comment out
