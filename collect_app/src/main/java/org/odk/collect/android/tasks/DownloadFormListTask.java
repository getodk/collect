        ...
        if (result.isOpenRosaResponse) {
            ...
            for (int i = 0; i < elements; ++i) {
                ...
                formList.put(formId, new FormDetails(formName, downloadUrl, manifestUrl, formId,
                        (version != null) ? version : majorMinorVersion, isNewerFormVersionAvailable, areNewerMediaFilesAvailable, false));     // smap add tasks_only
            }
        } else {
            ...
            for (int i = 0; i < formsCount; ++i) {
                ...
                if (tag.equalsIgnoreCase("form")) {
                    ...
                    formList.put(formName,
                            new FormDetails(formName, downloadUrl, null, formId, null, false, false, false));       // smap add tasks_only
