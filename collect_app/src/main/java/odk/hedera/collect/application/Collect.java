...
package odk.hedera.collect.application;
...
import odk.hedera.collect.injection.config.AppDependencyComponent;
import odk.hedera.collect.injection.config.DaggerAppDependencyComponent;
...
import static odk.hedera.collect.logic.PropertyManager.PROPMGR_USERNAME;
import static odk.hedera.collect.logic.PropertyManager.SCHEME_USERNAME;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_APP_LANGUAGE;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_USERNAME;
import static odk.hedera.collect.preferences.MetaKeys.KEY_GOOGLE_BUG_154855417_FIXED;
