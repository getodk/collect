...
import odk.hedera.collect.application.initialization.migration.Migration;

import static odk.hedera.collect.application.initialization.migration.MigrationUtils.combineKeys;
import static odk.hedera.collect.application.initialization.migration.MigrationUtils.moveKey;
import static odk.hedera.collect.application.initialization.migration.MigrationUtils.removeKey;
import static odk.hedera.collect.application.initialization.migration.MigrationUtils.renameKey;
import static odk.hedera.collect.application.initialization.migration.MigrationUtils.translateKey;
import static odk.hedera.collect.application.initialization.migration.MigrationUtils.translateValue;
import static odk.hedera.collect.preferences.GeneralKeys.BASEMAP_SOURCE_CARTO;
import static odk.hedera.collect.preferences.GeneralKeys.BASEMAP_SOURCE_OSM;
import static odk.hedera.collect.preferences.GeneralKeys.BASEMAP_SOURCE_STAMEN;
import static odk.hedera.collect.preferences.GeneralKeys.BASEMAP_SOURCE_USGS;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_BASEMAP_SOURCE;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_CARTO_MAP_STYLE;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_GOOGLE_MAP_STYLE;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_MAPBOX_MAP_STYLE;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_USGS_MAP_STYLE;
