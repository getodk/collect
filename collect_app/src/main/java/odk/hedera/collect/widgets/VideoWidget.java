...
import odk.hedera.collect.activities.CaptureSelfieVideoActivity;
...
import odk.hedera.collect.utilities.CameraUtils;
import odk.hedera.collect.utilities.ContentUriProvider;
import odk.hedera.collect.utilities.FileUtil;
import odk.hedera.collect.utilities.FileUtils;
import odk.hedera.collect.utilities.MediaManager;
import odk.hedera.collect.utilities.MediaUtil;
import odk.hedera.collect.utilities.ToastUtils;
import odk.hedera.collect.utilities.WidgetAppearanceUtils;
import odk.hedera.collect.widgets.interfaces.FileWidget;
import odk.hedera.collect.widgets.utilities.FileWidgetUtils;
...
import static odk.hedera.collect.analytics.AnalyticsEvents.REQUEST_HIGH_RES_VIDEO;
import static odk.hedera.collect.analytics.AnalyticsEvents.REQUEST_VIDEO_NOT_HIGH_RES;
...
public class VideoWidget extends QuestionWidget implements FileWidget {
     ...
     * @see odk.hedera.collect.activities.FormEntryActivity#onActivityResult(int, int, Intent)
     */
    @Override
