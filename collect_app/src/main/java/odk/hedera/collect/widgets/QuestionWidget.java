...
import odk.hedera.collect.formentry.questions.QuestionTextSizeHelper;
...
import odk.hedera.collect.preferences.GuidanceHint;
import odk.hedera.collect.utilities.AnimationUtils;
import odk.hedera.collect.utilities.FormEntryPromptUtils;
import odk.hedera.collect.utilities.PermissionUtils;
import odk.hedera.collect.utilities.SoftKeyboardUtils;
import odk.hedera.collect.utilities.StringUtils;
import odk.hedera.collect.utilities.ThemeUtils;
import odk.hedera.collect.utilities.ViewUtils;
...
import static odk.hedera.collect.analytics.AnalyticsEvents.AUDIO_QUESTION;
import static odk.hedera.collect.formentry.media.FormMediaUtils.getClipID;
import static odk.hedera.collect.formentry.media.FormMediaUtils.getPlayColor;
import static odk.hedera.collect.formentry.media.FormMediaUtils.getPlayableAudioURI;
import static odk.hedera.collect.injection.DaggerUtils.getComponent;
