...
import odk.hedera.collect.provider.InstanceProviderAPI;
...
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.CAN_EDIT_WHEN_COMPLETE;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.DELETED_DATE;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.DISPLAY_NAME;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.GEOMETRY;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.GEOMETRY_TYPE;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.INSTANCE_FILE_PATH;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.JR_FORM_ID;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.JR_VERSION;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.LAST_STATUS_CHANGE_DATE;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.STATUS;
import static odk.hedera.collect.provider.InstanceProviderAPI.InstanceColumns.SUBMISSION_URI;
