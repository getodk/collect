...
package odk.hedera.collect.database.helpers;

import android.database.SQLException;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import odk.hedera.collect.database.DatabaseContext;
import odk.hedera.collect.storage.StoragePathProvider;
import odk.hedera.collect.storage.StorageSubdirectory;
import odk.hedera.collect.utilities.SQLiteUtils;
...
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.AUTO_DELETE;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.AUTO_SEND;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.BASE64_RSA_PUBLIC_KEY;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.DATE;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.DESCRIPTION;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.DISPLAY_NAME;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.DISPLAY_SUBTEXT;
...
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.GEOMETRY_XPATH;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.JRCACHE_FILE_PATH;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.JR_FORM_ID;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.JR_VERSION;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.LANGUAGE;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.LAST_DETECTED_FORM_VERSION_HASH;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.MD5_HASH;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.SUBMISSION_URI;
