...
import odk.hedera.collect.activities.NotificationActivity;
import odk.hedera.collect.application.Collect;
import odk.hedera.collect.dao.FormsDao;
import odk.hedera.collect.logic.FormDetails;
...
import static odk.hedera.collect.activities.FormDownloadListActivity.DISPLAY_ONLY_UPDATED_FORMS;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_AUTOMATIC_UPDATE;
...
import static odk.hedera.collect.utilities.ApplicationConstants.RequestCodes.FORM_UPDATES_AVAILABLE_NOTIFICATION;
import static odk.hedera.collect.utilities.ApplicationConstants.RequestCodes.FORMS_DOWNLOADED_NOTIFICATION;
import static odk.hedera.collect.utilities.FormListDownloader.DL_AUTH_REQUIRED;
import static odk.hedera.collect.utilities.FormListDownloader.DL_ERROR_MSG;
import static odk.hedera.collect.utilities.NotificationUtils.FORM_UPDATE_NOTIFICATION_ID;
