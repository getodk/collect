...
package odk.hedera.collect.upload;
...
import odk.hedera.collect.forms.Form;
import odk.hedera.collect.instances.Instance;
...
import odk.hedera.collect.utilities.InstanceUploaderUtils;
...
import static odk.hedera.collect.analytics.AnalyticsEvents.SUBMISSION;
import static odk.hedera.collect.provider.FormsProviderAPI.FormsColumns.AUTO_SEND;
import static odk.hedera.collect.utilities.ApplicationConstants.RequestCodes.FORMS_UPLOADED_NOTIFICATION;
import static odk.hedera.collect.utilities.InstanceUploaderUtils.SPREADSHEET_UPLOADED_TO_GOOGLE_DRIVE;
