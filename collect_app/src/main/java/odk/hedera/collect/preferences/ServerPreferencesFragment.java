...
import odk.hedera.collect.listeners.OnBackPressedListener;
import odk.hedera.collect.listeners.PermissionListener;
import odk.hedera.collect.openrosa.OpenRosaAPIClient;
import odk.hedera.collect.preferences.filters.ControlCharacterFilter;
import odk.hedera.collect.preferences.filters.WhitespaceFilter;
import odk.hedera.collect.preferences.utilities.ChangingServerUrlUtils;
...
import odk.hedera.collect.utilities.gdrive.GoogleAccountsManager;
...
import static odk.hedera.collect.analytics.AnalyticsEvents.SET_CUSTOM_ENDPOINT;
import static odk.hedera.collect.analytics.AnalyticsEvents.SET_FALLBACK_SHEETS_URL;
import static odk.hedera.collect.analytics.AnalyticsEvents.SET_SERVER;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_FORMLIST_URL;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_PROTOCOL;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_SELECTED_GOOGLE_ACCOUNT;
import static odk.hedera.collect.preferences.GeneralKeys.KEY_SUBMISSION_URL;
import static odk.hedera.collect.preferences.PreferencesActivity.INTENT_KEY_ADMIN_MODE;
import static odk.hedera.collect.utilities.DialogUtils.showDialog;
