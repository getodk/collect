...
import odk.hedera.collect.fragments.dialogs.GoogleSheetsUploaderProgressDialog;
import odk.hedera.collect.injection.DaggerUtils;
import odk.hedera.collect.listeners.InstanceUploaderListener;
...
import odk.hedera.collect.tasks.InstanceGoogleSheetsUploaderTask;
import odk.hedera.collect.utilities.ArrayUtils;
...
import static odk.hedera.collect.fragments.dialogs.GoogleSheetsUploaderProgressDialog.GOOGLE_SHEETS_UPLOADER_PROGRESS_DIALOG_TAG;
import static odk.hedera.collect.utilities.gdrive.GoogleAccountsManager.showSettingsDialog;
