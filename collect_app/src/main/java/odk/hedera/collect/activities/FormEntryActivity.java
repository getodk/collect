...
import odk.hedera.collect.audio.AudioControllerView;
import odk.hedera.collect.dao.FormsDao;
import odk.hedera.collect.dao.helpers.ContentResolverHelper;
import odk.hedera.collect.dao.helpers.FormsDaoHelper;
import odk.hedera.collect.dao.helpers.InstancesDaoHelper;
import odk.hedera.collect.events.ReadPhoneStatePermissionRxEvent;
import odk.hedera.collect.events.RxEventBus;
import odk.hedera.collect.exception.JavaRosaException;
import odk.hedera.collect.formentry.FormLoadingDialogFragment;
import odk.hedera.collect.formentry.ODKView;
import odk.hedera.collect.formentry.QuitFormDialogFragment;
import odk.hedera.collect.formentry.FormEntryMenuDelegate;
import odk.hedera.collect.formentry.FormEntryViewModel;
import odk.hedera.collect.formentry.FormIndexAnimationHandler;
import odk.hedera.collect.formentry.audit.AuditEvent;
import odk.hedera.collect.formentry.audit.AuditUtils;
import odk.hedera.collect.formentry.audit.ChangesReasonPromptDialogFragment;
import odk.hedera.collect.formentry.audit.IdentifyUserPromptDialogFragment;
import odk.hedera.collect.formentry.audit.IdentityPromptViewModel;
import odk.hedera.collect.formentry.backgroundlocation.BackgroundLocationManager;
import odk.hedera.collect.formentry.backgroundlocation.BackgroundLocationViewModel;
import odk.hedera.collect.formentry.loading.FormInstanceFileCreator;
import odk.hedera.collect.formentry.repeats.AddRepeatDialog;
...
import odk.hedera.collect.fragments.MediaLoadingFragment;
import odk.hedera.collect.fragments.dialogs.CustomDatePickerDialog;
import odk.hedera.collect.fragments.dialogs.LocationProvidersDisabledDialog;
import odk.hedera.collect.fragments.dialogs.NumberPickerDialog;
import odk.hedera.collect.fragments.dialogs.ProgressDialogFragment;
import odk.hedera.collect.fragments.dialogs.RankingWidgetDialog;
import odk.hedera.collect.javarosawrapper.FormController;
import odk.hedera.collect.javarosawrapper.FormController.FailedConstraint;
import odk.hedera.collect.listeners.AdvanceToNextListener;
import odk.hedera.collect.listeners.FormLoaderListener;
import odk.hedera.collect.listeners.PermissionListener;
import odk.hedera.collect.listeners.SavePointListener;
import odk.hedera.collect.listeners.WidgetValueChangedListener;
import odk.hedera.collect.logic.FormInfo;
import odk.hedera.collect.logic.ImmutableDisplayableQuestion;
...
import odk.hedera.collect.tasks.FormLoaderTask;
import odk.hedera.collect.tasks.SaveFormIndexTask;
import odk.hedera.collect.tasks.SavePointTask;
import odk.hedera.collect.upload.AutoSendWorker;
import odk.hedera.collect.utilities.ApplicationConstants;
import odk.hedera.collect.utilities.DestroyableLifecyleOwner;
import odk.hedera.collect.utilities.DialogUtils;
import odk.hedera.collect.utilities.FlingRegister;
import odk.hedera.collect.utilities.FormNameUtils;
...
import odk.hedera.collect.utilities.QuestionFontSizeUtils;
import odk.hedera.collect.utilities.ScreenContext;
import odk.hedera.collect.utilities.SnackbarUtils;
import odk.hedera.collect.utilities.SoftKeyboardUtils;
import odk.hedera.collect.utilities.ToastUtils;
import odk.hedera.collect.widgets.DateTimeWidget;
import odk.hedera.collect.widgets.QuestionWidget;
import odk.hedera.collect.widgets.RangeWidget;
...
import static odk.hedera.collect.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static odk.hedera.collect.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static odk.hedera.collect.fragments.BarcodeWidgetScannerFragment.BARCODE_RESULT_KEY;
import static odk.hedera.collect.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static odk.hedera.collect.utilities.AnimationUtils.areAnimationsEnabled;
import static odk.hedera.collect.utilities.ApplicationConstants.RequestCodes;
...
import static odk.hedera.collect.utilities.PermissionUtils.areStoragePermissionsGranted;
import static odk.hedera.collect.utilities.PermissionUtils.finishAllActivities;
import static odk.hedera.collect.utilities.ToastUtils.showLongToast;
import static odk.hedera.collect.utilities.ToastUtils.showShortToast;
