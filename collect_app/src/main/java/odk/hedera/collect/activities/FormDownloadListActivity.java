...
import odk.hedera.collect.activities.viewmodels.FormDownloadListViewModel;
import odk.hedera.collect.adapters.FormDownloadListAdapter;
...
import odk.hedera.collect.formentry.RefreshFormListDialogFragment;
import odk.hedera.collect.injection.DaggerUtils;
import odk.hedera.collect.listeners.DownloadFormsTaskListener;
import odk.hedera.collect.listeners.FormListDownloaderListener;
...
import odk.hedera.collect.openrosa.HttpCredentialsInterface;
import odk.hedera.collect.storage.StorageInitializer;
import odk.hedera.collect.tasks.DownloadFormListTask;
import odk.hedera.collect.tasks.DownloadFormsTask;
