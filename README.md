...
**MapLibre Maps SDK for Android**: When the "MapLibre" basemap source is selected in Settings > Maps, ODK Collect uses the MapLibre SDK for displaying maps in the geospatial question types (GeoPoint, GeoTrace, and GeoShape).  To enable this API:
