...
class SelectionMapFragmentTest {
    ...
    fun `updates markers when items update`() {
        val items = listOf(
            MappableItemsFixtures.actionMappablePoint().copy(id = 0, point = MapPoint(40.0, 0.0)),
            MappableItemsFixtures.actionMappablePoint().copy(id = 1, point = MapPoint(41.0, 0.0))
        )
    ...
    fun `updates item count when items update`() {
        val items: List<MappableItem> = listOf(
            MappableItemsFixtures.actionMappablePoint().copy(id = 0),
            MappableItemsFixtures.actionMappablePoint().copy(id = 1)
        )
    ...
    fun `shows polyline when item is MappableLine`() {
        val items: List<MappableItem.Line> = listOf(
            MappableItemsFixtures.actionMappableLine().copy(
                id = 0,
                points = listOf(
                    MapPoint(40.0, 0.0),
                    MapPoint(41.0, 0.0)
    ...
    fun `shows polygon when item is MappablePolygon`() {
        val items: List<MappableItem.Polygon> = listOf(
            MappableItemsFixtures.actionMappablePolygon().copy(
                id = 0,
                points = listOf(
                    MapPoint(40.0, 0.0),
                    MapPoint(41.0, 0.0),
    ...
    fun `zooms to fit all points in for item with multiple points`() {
        ...
        val items: List<MappableItem> = listOf(
            MappableItemsFixtures.actionMappableLine().copy(id = 0, points = points)
        )
    ...
    fun `does not zoom to fit all items again when they change`() {
        ...
        itemsLiveData.value =
            listOf(MappableItemsFixtures.actionMappablePoint().copy(id = 0, point = MapPoint(52.0, 0.0)))
    ...
    fun `clicking on item with multiple points zooms to fit all item points`() {
        ...
        val items = listOf(
            MappableItemsFixtures.actionMappableLine().copy(id = 0, points = listOf(MapPoint(40.0, 0.0))),
            MappableItemsFixtures.actionMappableLine().copy(id = 1, points = itemPoints)
        )
        whenever(data.getMappableItems()).thenReturn(MutableLiveData(items))
    ...
    fun `clicking on item always selects correct item`() {
        val items = listOf(
            MappableItemsFixtures.actionMappableLine().copy(id = 0, points = listOf(MapPoint(40.0, 0.0), MapPoint(41.0, 0.0))),
            MappableItemsFixtures.actionMappablePoint().copy(id = 1, point = MapPoint(45.0, 0.0))
        )
        whenever(data.getMappableItems()).thenReturn(MutableLiveData(items))
    ...
    fun `clicking on item sets item on summary sheet`() {
        val items = listOf(
            MappableItemsFixtures.actionMappablePoint().copy(id = 0, name = "Blah1"),
            MappableItemsFixtures.actionMappablePoint().copy(id = 1, name = "Blah2")
        )
        whenever(data.getMappableItems()).thenReturn(MutableLiveData(items))
    ...
    fun `clicking map with an item selected deselects it`() {
        val item = MappableItemsFixtures.actionMappablePoint().copy(id = 0, name = "Blah1")
    ...
    fun `pressing back with an item selected deselects it`() {
        val item = MappableItemsFixtures.actionMappablePoint()
    ...
    fun `recreating after deselecting item has no item selected`() {
        val items = listOf(MappableItemsFixtures.actionMappablePoint().copy(id = 0, name = "Point1"))
        whenever(data.getMappableItems()).thenReturn(MutableLiveData(items))
    ...
    fun `centers on already selected item`() {
        val items = listOf(
            MappableItemsFixtures.actionMappablePoint().copy(id = 0, point = MapPoint(40.0, 0.0)),
            MappableItemsFixtures.actionMappablePoint().copy(id = 1, point = MapPoint(40.1, 0.0))
        )
        whenever(data.getMappableItems()).thenReturn(MutableLiveData(items))
    ...
    fun `recreating maintains selection`() {
        val items = listOf(
            MappableItemsFixtures.actionMappablePoint().copy(id = 0, point = MapPoint(40.0, 0.0), name = "Point1"),
            MappableItemsFixtures.actionMappablePoint().copy(id = 1, point = MapPoint(41.0, 0.0), name = "Point2")
        )
        whenever(data.getMappableItems()).thenReturn(MutableLiveData(items))
