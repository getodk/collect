...
object Dependencies {
    ...
    const val androidx_startup = "androidx.startup:startup-runtime:1.2.0"
    ...
    const val androidx_work_runtime = "androidx.work:work-runtime-ktx:${Versions.work}"
    ...
    const val osmdroid = "org.osmdroid:osmdroid-android:6.1.20"
    ...
    const val burgstaller_okhttp_digest = "io.github.rburgst:okhttp-digest:3.1.1"
    ...
    const val danlew_android_joda = "net.danlew:android.joda:2.13.0"
    ...
    const val kotlinx_coroutines_android = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.9.0"
    ...
    const val kotlin_stdlib = "org.jetbrains.kotlin:kotlin-stdlib:2.0.21"
    const val gson = "com.google.code.gson:gson:2.11.0"
    const val firebase_analytics = "com.google.firebase:firebase-analytics-ktx:22.1.2"
    const val firebase_crashlytics = "com.google.firebase:firebase-crashlytics-ktx:19.2.1"
    ...
    const val slf4j_timber = "com.arcao:slf4j-timber:3.1"
    const val emoji_java = "com.vdurmont:emoji-java:5.1.1"
    const val json_schema_validator = "com.networknt:json-schema-validator:1.5.2"
    ...
    const val mockito_android = "org.mockito:mockito-android:5.14.2"
    const val mockito_core = "org.mockito:mockito-core:5.14.2"
    ...
    const val hamcrest = "org.hamcrest:hamcrest:3.0"
