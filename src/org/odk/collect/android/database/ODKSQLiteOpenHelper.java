...
/**
 * We've taken this from Android's SQLiteOpenHelper.  However, we can't appropriately lock the database
 * so there may be issues if a thread opens the database read-only and another thread tries to open
 * the database read/write.  I don't think this will ever happen in ODK, though.  (fingers crossed).
 */
